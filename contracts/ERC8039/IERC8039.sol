...
interface IERC8039 {
     ...
     * Examples: keccak256("groth16-circom"), keccak256("honk-barretenberg"), keccak256("sp1")
     * 
...
library ProofTypes {
     ...
     */
    bytes32 public constant HALO2_PSE = keccak256("plonk-halo2_pse");
     ...
     * License: MIT
     */
    bytes32 public constant HALO2_AXIOM = keccak256("plonk-halo2_axiom");
